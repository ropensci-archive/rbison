...
```r
library(rbison); library(sp); library(plyr); library(httr); library(rjson); library(gridExtra); library(mapproj); library(ggplot2); library(maps); library(rgeos); library(rgdal)
```
