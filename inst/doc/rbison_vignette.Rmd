...
##### inspect summary
```{r five, comment=NA, warning=FALSE}
bison_data(out)
```
...
```{r countyfips, comment=NA, warning=FALSE}
...
```{r countyname, comment=NA, warning=FALSE}
...
```{r wellknowntext, comment=NA, warning=FALSE}
...
```{r boundbox, comment=NA, warning=FALSE}
