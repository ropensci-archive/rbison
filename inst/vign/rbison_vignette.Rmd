...
```{r two, message=FALSE, warning=FALSE, cache=TRUE}
bison_data(out)
```
...
##### get data
```{r four, message=FALSE, warning=FALSE, cache=TRUE}
out <- bison(species="Bison bison", count=600)
```

##### inspect summary
```{r five, message=FALSE, warning=FALSE, cache=TRUE}
bison_data(out)
```
...
##### inspect summary
```{r eight, message=FALSE, warning=FALSE, cache=TRUE}
bison_data(out)
```

##### map occurrences
```{r nine, fig.width=6, fig.height=4, warning=FALSE, cache=TRUE}
bisonmap(out, tomap="state")
```
...
```{r countyfips, message=FALSE, warning=FALSE, cache=TRUE}
...
```{r countyname, message=FALSE, warning=FALSE, cache=TRUE}
...
```{r wellknowntext, message=FALSE, warning=FALSE, cache=TRUE}
...
```{r boundbox, message=FALSE, warning=FALSE, cache=TRUE}
